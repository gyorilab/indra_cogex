...
from .queries_web import search_ns, validation_ns, evidence_ns, relationship_ns, disease_ns, publication_ns, \
    ontology_ns, cell_line_ns, clinical_ns, mutation_ns, analysis_ns, network_ns
